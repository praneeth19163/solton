<html>
    ...
    <body>
        ...
        <div class="container">
        <div ><a href="missing.php" ><input type="button" value="Missing Items" name="prost" class="item1"></a>
    
        </div>
        <div><a href="found.php" ><input type="button" value="Found Items" name="prost" class="item2"></a>
            
        </div>
        <div><a href="Receiveditems.php" ><input type="button" value="Got Items" name="prost" class="item3"></a>
